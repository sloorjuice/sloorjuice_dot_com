...
export default async function Home() {
  ...
  const pixelArt = [
    { src: "/pixel_art/borger.png", alt: "Borger", title: "Borger!"},
    { src: "/pixel_art/cheeborger.png", alt: "CheeBorger", title: "CheeBorger!"},
    { src: "/pixel_art/alien.gif", alt: "Alien Guy", title: "Cool Alien Character" },
    { src: "/pixel_art/me_idle.gif", alt: "Celeste Inspired Sprite", title: "Celeste inspired Character"},
    { src: "/pixel_art/me_run.gif", alt: "Pixel art 3", title: "Celeste inspired Character" },
    { src: "/pixel_art/orb.gif", alt: "Pixel art 3", title: "Cool Glowing Orb" },
    { src: "/pixel_art/yellowguy_walk.gif", alt: "Pixel art 3", title: "Cool lil' Slug Guy" },
    { src: "/pixel_art/yarn.gif", alt: "Yarn Ball", title: "Yarn Ball!"},
    { src: "/pixel_art/KittySoul.gif", alt: "Kitty Soul", title: "Kitty Soul (Made for a game I was working on)"},
    { src: "/pixel_art/CelestedInspriedBackground.png", alt: "Pixel art 2", title: "SPOOKY SCARY" },
